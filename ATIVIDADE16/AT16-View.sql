...
from funcionarios
where salario > 4000.00 and cpf is not null;
...
select count(Codigo) as gerentes
from funcionarios
...
select avg(Salario)  as media_desenvolvedor
from funcionarios
...
select count(Codigo) as numero_funcionarios
from funcionarios
where SegundoNome or UltimoNome = 'Almeida' or Salario < 3500.00;
