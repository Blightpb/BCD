...
/* 2. Crie uma view chamada "vw_produtos_estoque" que selecione o nome, 
categoria e quantidade em estoque dos produtos com estoque maior que 100.*/
...
month(data_nascimento) as mês_nascimento
from tb_cliente;

select * from vw_clientes_nascimento;

/* 4. Crie uma view chamada "vw_produtos_precos" que selecione o nome do produto e um novo campo 
"lucro" com a diferença entre o preço de venda e o preço de compra. */
create view vw_produtos_precos as
select nome_produto, preco_venda, preco_compra,
...
/* 7. Usando a view "vw_produtos_estoque", selecione o nome e a categoria dos produtos que
 possuem mais de 150 unidades em estoque. */
